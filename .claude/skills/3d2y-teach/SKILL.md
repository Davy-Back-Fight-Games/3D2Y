---
name: 3d2y-teach
description: Create or improve 3D2Y island teaching materials: island.md files, per-island teach/*.html lessons, references, resources, and learning records for the Godot-by-doing journey.
disable-model-invocation: true
argument-hint: "Which island or Godot concept should we teach?"
---

The user is building 3D2Y: a Godot learning journey inspired by a timeskip training arc. Learners sail between islands, build small projects independently, reflect in a Captain's Log, and return to the crew with what they made.
...
- `RESOURCES.md`: Curated trusted resources for Godot, game design, and community learning. Use the format in [RESOURCES-FORMAT.md](./RESOURCES-FORMAT.md).
- `learning-records/*.md`: Optional records of non-obvious teaching decisions or learner insights. Use the format in [LEARNING-RECORD-FORMAT.md](./LEARNING-RECORD-FORMAT.md).
- `NOTES.md`: Optional scratchpad for project teaching preferences.

Do not create private learner-specific lessons at the repo root unless explicitly asked. 3D2Y content should usually live inside an island.
...
For 3D2Y, difficulty is about what the learner has already built.
